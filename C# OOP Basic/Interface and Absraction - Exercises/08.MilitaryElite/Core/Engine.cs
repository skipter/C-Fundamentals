    ...
    public class Engine
    {
        ...
        private ISoldier GetEngineer(int id, string firstName, string lastName, decimal salary, string[] inputArgs)
        {
            ...
            for (int i = 6; i < inputArgs.Length; i+=2)
            {
                ...
                int workHours = int.Parse(inputArgs[i + 1]);
        ...
        {
            ILieutenantGeneral leitenantGeneral = new LieutenantGeneral(id, firstName, lastName, salary);
            ...
            for (int i = 5; i < inputArgs.Length; i++)
            {
                ...
                leitenantGeneral.Private.Add(privateSoldier);
            }
            return leitenantGeneral;
        }

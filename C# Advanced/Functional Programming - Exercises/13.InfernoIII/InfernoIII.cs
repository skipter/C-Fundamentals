...
namespace _13.InfernoIII
{
    class InfernoIII
    {
        static void Main()
        {
            ...
            initial.Count == 1 ? initial[0] == b : a == 0 ? initial[a] + initial[a + 1] == b : 
            a == initial.Count - 1 ? initial[a] + initial[a - 1] == b : initial[a - 1] + initial[a] + initial[a + 1] == b;

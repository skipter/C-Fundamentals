namespace Travel.Entities
{
	...
	public class Airport : IAirport
	{
        ...
        public IPassenger GetPassenger(string username) => this.passengers.FirstOrDefault(x => x.Username == username);

		public ITrip GetTrip(string id) => this.trips.FirstOrDefault(x => x.Id == id);
